...
<div class="navcontainer">
  ...
  <div class="bannerContainerggs">
    <div class="bannerWrapper">
      <img id="tk8logo" src="images/GGStrive_Logo.webp" alt="" />
    </div>
  </div>
  ...
  echo "<form method='post' action='caller.php'>
    ...
    <input type='hidden' name='next_page' value='gamepage-ggs.php'>
    <button class='commentBtn' type='submit' name='submitCommentggs'>Comment</button>
</form>";
  ?>
  <form id="commentggs" method='post' action='caller.php'>
    <input type='hidden' name='next_page' value='ggs'>
    <button class="commentBtn" type="button" onclick="showCommentsggs()">Show Comments</button>
  </form>
  <?php
