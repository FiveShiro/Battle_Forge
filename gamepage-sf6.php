...
<body>
  ...
  <div class="bannerContainersf6">
    <div class="sf6">
      <img id="tk8logo" src="images/sf6_logo.png" alt=""/>
    </div>
  </div>
  <!--Game's original description, copy paste them from steam-->
  <p class="pGames">YOUR MOMENT, YOUR FIGHT</p>
  <!--Useful web links-->
  ...
  <div class="comLinksContainer">
    ...
    <div class="comLinksList">
      <ul>
        <a href="https://www.reddit.com/r/StreetFighter/?rdt=47049" target="_blank"><img src="images/reddit-icon.png"
            alt="" width="80" /></a>
